...
- Será utilizado operadores relacionais (==) e estruturas condicionais (if/else) para validar as escolhas;
...
int main(){
    int especialidade, medico, data, horario; //armazenamento das variáveis.
    int confirma; //armazenamento das variáveis para a confirmação final.

    printf("****Doctor Link - Agendamento de consultas****\n\n");

// Escolha da especialidade.
    printf("Digite o número da especialidade desejada:\n");
